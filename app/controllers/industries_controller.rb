class IndustriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @industry.save
        ...
        format.html { redirect_to categories_list_industry_categories_url,  notice: 'Industry was successfully created.' }
  ...
  private
    ...
    def industry_params
      params.require(:industry).permit(:name, :description, :industry_category_id, :image)
    end
end
